...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3examen2_danielalvarado.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3examen2_danielalvarado.exe: ${OBJECTFILES}
...
${OBJECTDIR}/ManejadorRelaciones.o: ManejadorRelaciones.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManejadorRelaciones.o ManejadorRelaciones.cpp

${OBJECTDIR}/P3Examen2_DanielAlvarado.o: P3Examen2_DanielAlvarado.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/P3Examen2_DanielAlvarado.o P3Examen2_DanielAlvarado.cpp
